...
const GROUPS = [
  { slug: 'music-group',                name: 'Music Group',             icon: '🎵', abbr: undefined,  tagline: 'Anointed sounds that usher in presence',                  color: '#153093', bg: '#eef2ff' },
  { slug: 'locomotive-group',           name: 'Locomotive Group',        icon: '🚂', abbr: 'MJK',      tagline: 'Making Jesus Known through follow-up',                   color: '#22b573', bg: '#ecfdf5' },
  { slug: 'transformative-word-group',  name: 'Transformative Word',     icon: '📖', abbr: 'TWG',      tagline: 'Rooting believers in the Word',                           color: '#f7931e', bg: '#fff7ed' },
  { slug: 'tremendous-power-group',     name: 'Tremendous Power',        icon: '⚡', abbr: 'TPG',      tagline: 'Spirit-empowered ministry and intercession',             color: '#153093', bg: '#eef2ff' },
  { slug: 'community-impact-group',     name: 'Community Impact',        icon: '🌍', abbr: 'GIP',      tagline: 'Transforming communities, cities, nations',              color: '#22b573', bg: '#ecfdf5' },
  { slug: 'media-operations-group',     name: 'Media Operations',        icon: '🎬', abbr: undefined,  tagline: 'Engineering · Design · Social · AV · Photography',       color: '#4ea8f9', bg: '#eff6ff' },
  { slug: 'administrative-support-group', name: 'Administrative Support', icon: '📋', abbr: undefined, tagline: 'Admin, protocol, and operations excellence',              color: '#6b7280', bg: '#f9fafb' },
]
  ...
  return (
    <AnimatedSection variant="fadeUp" delay={index * 60}>
      ...
      >
        ...
        {/* Icon container */}
        <div
          className="text-3xl mb-4 w-14 h-14 rounded-2xl flex items-center justify-center relative z-10"
          style={{
