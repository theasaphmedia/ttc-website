  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--off-white)' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Tab bar */}
        <div className="flex gap-2 mb-8 bg-white p-1.5 rounded-2xl w-fit" style={{ border: '1px solid var(--gray-200)' }}>
          {TABS.map(t => {
            const Icon = t.icon
            ...
            return (
              <button
                ...
                style={{
                  background: active ? '#153093' : 'transparent',
                  ...
                  {devotionals.map(dv => (
                    <div key={dv.id} className="p-4 rounded-2xl" style={{ background: 'var(--off-white)', border: '1px solid var(--gray-200)' }}>
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          onClick={() => deleteDevotional(dv.id)}
