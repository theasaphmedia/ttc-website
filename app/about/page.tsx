      ...
      >
        ...
        <div className="container-ttc relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full bg-carrot-orange" />
              About TTC
            </div>
            ...
            >
              About The
              <br />
              <span className="text-gradient-blue" style={{ WebkitTextFillColor: 'unset' }}>
                Transformation Camp
              </span>
            </h1>

            <p
              className="font-accent text-3xl md:text-4xl mt-2 mb-6"
              style={{ color: '#f7931e' }}
            >
            ...
            <p
              ...
              style={{ color: 'rgba(255,255,255,0.75)', fontFamily: 'var(--font-open-sans)' }}
            >
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <Link href="/programs" className="btn-orange">
                Join Us
                <ArrowRight size={16} />
              </Link>
